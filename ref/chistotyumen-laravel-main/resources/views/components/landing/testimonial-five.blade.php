    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 col-xl-6">
                <div class="testimonial-five-left-box"></div>
            </div>
            <div class="col-md-12 col-xl-6">
                <div class="testimonial-five-right-box pbmit-bg-color-blackish">
                    <div class="testimonial-five-slider">
                        ...
                        <div class="swiper-slider overflow-visible" data-autoplay="true" data-loop="false" data-dots="true" data-arrows="false" data-outside="true" data-columns="1" data-margin="30" data-effect="slide">
                            <div class="swiper-wrapper">
                                @foreach ($data->items as $t)
                                    <article class="pbmit-testimonial-style-5 swiper-slide">
                                        <div class="pbminfotech-post-item">
                                            <div class="pbmit-box-content-wrap">
                                                <div class="pbminfotech-box-star-ratings" aria-hidden="true">
                                                    @for ($i = 0; $i < 5; $i++)
                                                    ...
                                                    <div class="pbminfotech-box-img">
                                                        <div class="pbmit-featured-img-wrapper">
                                                            <div class="pbmit-featured-wrapper">
                                                                <img src="{{ asset($t->imagePath) }}" class="img-fluid" alt="{{ $t->imageAlt }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="pbmit-auther-content">
                                                        <h3 class="pbminfotech-box-title">{{ $t->authorName }}</h3>
                                                        <div class="pbminfotech-testimonial-detail">{{ $t->authorDetail }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="pbmit-ihbox-headingicon">
                                <div class="pbmit-ihbox-contents d-flex align-items-center">
                                    <div class="pbmit-title-wrap">
                                        <h2 class="pbmit-element-title">{{ $data->ratingValue }}</h2>
                                    </div>
                                    <div class="pbmit-icon-wrap">
                                        <div class="pbmit-ihbox-svg">
                                            <div class="pbmit-ihbox-svg-wrapper">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="512" height="90.51" viewBox="0 0 512 90.51" aria-hidden="true">
                                        ...
                                        <h3 class="pbmit-element-heading">{{ $data->ratingCaption }}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
